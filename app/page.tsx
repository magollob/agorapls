          ...
          <section className="py-16 bg-gradient-to-r from-green-50 to-teal-50">
            <div className="container mx-auto px-4 text-center">
              ...
              <Button
                ...
                onClick={() => window.open("https://pay.kiwify.com.br/IzAA7ol", "_blank")} // Replace with actual bonus link if different
              >
              ...
              <Card className="bg-white/90 backdrop-blur-sm border-0 shadow-2xl max-w-2xl mx-auto">
                <CardContent className="p-8">
                  ...
                  <Button
                    ...
                    onClick={() => window.open("https://pay.kiwify.com.br/IzAA7ol", "_blank")}
                  >
